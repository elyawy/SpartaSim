...
vector<string> Simulator::simulateBasedOnTree(string treeFileName) {
	...
	getDistribution(length_dist_deletions, SpartaABC_options::_lengthDistribution, _Deletion_params, MaxIndelSize);
	getDistribution(length_dist_insertions, SpartaABC_options::_lengthDistribution, _Insertion_params, MaxIndelSize);

...
class Simulator {
	public:
		explicit Simulator(size_t rootLength, Vdouble Insertion_params, Vdouble Deletion_params, double IR, double DR) : _rootLength(rootLength), _Insertion_params(Insertion_params), _Deletion_params(Deletion_params), _IR(IR), _DR(DR) {};

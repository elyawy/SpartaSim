...
bool SpartaABC_options::_predefinedMode;
string SpartaABC_options::_predefinedSimsFile;
...
int SpartaABC_options::_numDistributionParams;

double SpartaABC_options::_minAIVal;
double SpartaABC_options::_maxAIVal;
double SpartaABC_options::_minADVal;
double SpartaABC_options::_maxADVal;

double SpartaABC_options::_minALavalette;
double SpartaABC_options::_maxALavalette;
double SpartaABC_options::_minCLavalette;
double SpartaABC_options::_maxCLavalette;


double SpartaABC_options::_minLambdaPoisson;
double SpartaABC_options::_maxLambdaPoisson;

double SpartaABC_options::_minPGeometric;
double SpartaABC_options::_maxPGeometric;


double SpartaABC_options::_minIRVal;
double SpartaABC_options::_maxIRVal;
double SpartaABC_options::_minDRVal;
double SpartaABC_options::_maxDRVal;
...
string SpartaABC_options::_lengthDistribution;
...
void SpartaABC_options::initDefault() {
	...
	_numDistributionParams = 1;
	// various distribution parameters limits:
	// for zipf:
	_minAIVal = 1.001;
	_maxAIVal = 2.0;
	_minADVal = 1.001;
	...
	Parameters::addParameter("_predefinedMode",_predefinedMode);
	Parameters::addParameter("_predefinedSimsFile",_predefinedSimsFile);
	...
	Parameters::addParameter("_minAIVal", _minAIVal);
	Parameters::addParameter("_maxAIVal", _maxAIVal);
	Parameters::addParameter("_minADVal", _minADVal);
	Parameters::addParameter("_maxADVal", _maxADVal);

	Parameters::addParameter("_minALavalette", _minALavalette);
	Parameters::addParameter("_maxALavalette", _maxALavalette);
	Parameters::addParameter("_minCLavalette", _minCLavalette);
	Parameters::addParameter("_maxCLavalette", _maxCLavalette);
	// for poisson;
	Parameters::addParameter("_minLambdaPoisson", _minLambdaPoisson);
	Parameters::addParameter("_maxLambdaPoisson", _maxLambdaPoisson);
	// for geometric:
	Parameters::addParameter("_minPGeometric", _minPGeometric);
	Parameters::addParameter("_maxPGeometric", _maxPGeometric);


	Parameters::addParameter("_minIRVal", _minIRVal);
	Parameters::addParameter("_maxIRVal", _maxIRVal);
	Parameters::addParameter("_minDRVal", _minDRVal);
	Parameters::addParameter("_maxDRVal", _maxDRVal);
	...
	Parameters::addParameter("_lengthDistribution",_lengthDistribution);
}
...
void SpartaABC_options::getParamsFromFile(const string& paramFileName)
{
	...
	_predefinedMode = (Parameters::getInt("_predefinedMode") == 1) ? true : false;
	_predefinedSimsFile = Parameters::getString("_predefinedSimsFile");
	...
	_minDRVal = Parameters::getFloat("_minDRVal");
	_maxDRVal = Parameters::getFloat("_maxDRVal");

	_lengthDistribution = Parameters::getString("_lengthDistribution");
	if (_lengthDistribution == "zipf"){
		_minAIVal = Parameters::getFloat("_minAIVal");
		_maxAIVal = Parameters::getFloat("_maxAIVal");
		_minADVal = Parameters::getFloat("_minADVal");
		_maxADVal = Parameters::getFloat("_maxADVal");

		_numDistributionParams = 1;

	}
	if (_lengthDistribution == "lavalette"){
		_minALavalette = Parameters::getFloat("_minALavalette");
		_maxALavalette = Parameters::getFloat("_maxALavalette");
		_minCLavalette = Parameters::getFloat("_minCLavalette");
		_maxCLavalette = Parameters::getFloat("_maxCLavalette");
		_numDistributionParams = 2;

	}
	if (_lengthDistribution == "poisson"){
		_minLambdaPoisson = Parameters::getFloat("_minLambdaPoisson");
		_maxLambdaPoisson = Parameters::getFloat("_maxLambdaPoisson");
		_numDistributionParams = 1;
	}
	if (_lengthDistribution == "geometric"){
		_minPGeometric = Parameters::getFloat("_minPGeometric");
		_maxPGeometric = Parameters::getFloat("_maxPGeometric");
		_numDistributionParams = 1;
	}
